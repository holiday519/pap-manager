...
import com.pxene.pap.domain.model.AdvertiserModelExample.Criteria;
...
//        }
    ...
    public AdvertiserBean findAdvertiserById(String id) throws Exception
    {
        ...
        com.pxene.pap.domain.model.IndustryKpiModelExample.Criteria criteria = example.createCriteria();
    ...
    public List<AdvertiserBean> listAdvertisers(String name) throws Exception
    {
        ...
        else
        {
            ...
            for (AdvertiserModel advertiserModel : advertiserModels)
            {
                ...
                com.pxene.pap.domain.model.IndustryKpiModelExample.Criteria industryKpiModelExampleCriteria = industryKpiModelExample.createCriteria();
