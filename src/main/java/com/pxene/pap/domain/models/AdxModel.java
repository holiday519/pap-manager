...
public class AdxModel {
    ...
    private String creativeAuditStateQueryUrl;
    ...
    public String getCreativeAuditStateQueryUrl() {
        return creativeAuditStateQueryUrl;
    }

    public void setCreativeAuditStateQueryUrl(String creativeAuditStateQueryUrl) {
        this.creativeAuditStateQueryUrl = creativeAuditStateQueryUrl == null ? null : creativeAuditStateQueryUrl.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", creativeAuditStateQueryUrl=").append(creativeAuditStateQueryUrl);
