 ...
 * @author ningyu
 */
public class APIAdvertiserLicence extends BaseBean
{
    /**
     * 资质类型或行业类型，
     * 必填，
    ...
    public APIAdvertiserLicence()
    {
        super();
    }
    public APIAdvertiserLicence(int type, String name, String number, String validDate, List<Byte[]> imgDatas, List<String> imgUrls)
    {
        super();
        this.type = type;
        this.name = name;
    ...
    {
        return "APIAdvertiserLicence [type=" + type + ", name=" + name + ", number=" + number + ", validDate=" + validDate + ", imgDatas=" + imgDatas + ", imgUrls=" + imgUrls + "]";
    }
}
