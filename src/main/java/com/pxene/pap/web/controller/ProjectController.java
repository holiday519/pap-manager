...
public class ProjectController {
	...
	@ResponseBody
	public String selectProjects(@RequestParam(required = false) String name,@RequestParam(required = false) String advertiserId, @RequestParam(required = false) Integer pageNo, @RequestParam(required = false) Integer pageSize, HttpServletRequest request, HttpServletResponse response) throws Exception {
