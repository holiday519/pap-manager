...
public class CreativeRuleController {
    ...
    @ResponseBody
	public String listCreativeRules(@RequestParam(required = false) String name, @RequestParam(required = false) Integer pageNo, @RequestParam(required = false) Integer pageSize, HttpServletResponse response) throws Exception {
