...
public class AppDataHourController
{
    ...
    @ResponseBody
    public String listAppDataHours(@RequestParam(required = true) String campaignId, @RequestParam(required = true) long beginTime, @RequestParam(required = true) long endTime, @RequestParam(required = false) Integer pageNo, @RequestParam(required = false) Integer pageSize, HttpServletResponse response) throws Exception
    {
