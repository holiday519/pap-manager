...
public class AppFlowController
{
    ...
    @ResponseBody
    public String listAppFlows(@RequestParam(required = true) Date beginTime, @RequestParam(required = true) Date endTime, @RequestParam(required = true) int limitNum, HttpServletResponse response) throws Exception
    {
    	Page<Object> pager = null;
    	
        List<AppFlowBean> appFlowHourList = appFlowHourService.listAppFlows(beginTime, endTime, limitNum);
