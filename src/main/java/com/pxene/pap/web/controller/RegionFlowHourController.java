...
public class RegionFlowHourController
{
    ...
    @ResponseBody
    public String listRegionFlowHours(@RequestParam(required = true) Date beginTime, @RequestParam(required = true) Date endTime, @RequestParam(required = true) int limitNum, HttpServletResponse response) throws Exception
    {
